						...
						<tr> 
							...
							<td colspan="3">
									...
									if(isset($_SESSION['login_user'])){ ?>
										<button class="btn btn-secondary btn-block mainfullbtncolor checkoutbtn ">Checkout </button>
									<?php
									 } else{
										$_SESSION['cartstatus']='order';
									?>
									<a href="login.php" class="btn btn-danger btn-block mainfullbtncolor"> Check Out </a>
